...
/**
 * Class ecomprocessing_direct
 */
class ecomprocessing_direct extends ecomprocessing_method_base
{
    /**
     * Credit Card Type
     * @var null|string
    ...
    /**
     * ecomprocessing_direct constructor.
     */
    ...
    protected function doBeforeProcessPayment()
    {
        ...
        try {
            ...
            $errorMessage         = MODULE_PAYMENT_ECOMPROCESSING_DIRECT_ERROR_CHECK_CREDENTIALS .
                                    PHP_EOL .
                                    $e->getMessage();
            $this->responseObject = null;
        } catch (\Exception $e) {
