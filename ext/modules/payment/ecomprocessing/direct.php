...
if (!class_exists("ecomprocessing_notification_base")) {
    require_once DIR_FS_CATALOG . 'ext/modules/payment/ecomprocessing/notification_base.php';
}

/**
 * Direct Payment Method Notification Handler Class
 * Class ecomprocessing_direct_notification
 */
class ecomprocessing_direct_notification extends ecomprocessing_notification_base
{
    protected function getTableNameTransactions()
    {
        return static::ECOMPROCESSING_DIRECT_TRANSACTIONS_TABLE_NAME;
    }

    public function __construct()
    {
        $this->code = static::ECOMPROCESSING_DIRECT_METHOD_CODE;
        parent::__construct();
    }
...
$notification = new ecomprocessing_direct_notification();
